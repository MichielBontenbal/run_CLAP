...
try:
    while current_time - start_time < DURATION:
        ...
        # This represents the average usage across all cores.
        # On multi-core systems, it can exceed 100% if calculated differently,
        # but psutil.cpu_percent() returns a value capped at 100% representing
        # the overall percentage of *time* the CPU(s) were busy.
...
if not timestamps_list: # Check if any data was collected
    ...
    try:
        ...
        plt.title(f"Raspberry Pi CPU Usage Over ~{DURATION} Seconds")
        ...
        print("Ensure you have a display environment available (e.g., running via SSH with X11 forwarding, or directly on the Pi's desktop).")
        print("If running headless, consider saving the plot to a file instead:")
        # Example of saving instead of showing:
        # plot_filename = "cpu_usage_plot.png"
